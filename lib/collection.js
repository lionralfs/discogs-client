...
export default function (client) {
     ...
     * @typedef {{instance_id: number; resource_url: string}} AddReleaseResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<AddReleaseResponse>>}
     *
     ...
     * @param {string} user - The user name
     * @typedef {{fields: Array<{name: string; type: string; public: boolean; position: number; id: number; options?: Array<string>; lines?: number}>}} GetFieldsResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<GetFieldsResponse>>>}
     *
     ...
     * @param {string} user - The user name
     * @typedef {{maximum: string; median: string; minimum: string}} CollectionValueResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<CollectionValueResponse>>>}
     *
