...
export default function (client) {
     ...
     * @param {string} user - The user name
     * @param {import('./client.js').PaginationParameters & import('./client.js').SortParameters<'label'|'artist'|'title'|'catno'|'format'|'rating'|'year'|'added'>} [params] - Optional pagination and sorting params
     * @returns {Promise<unknown>}
     *
     * @example
     ...
     * @param {string} user - The user name
     * @param {import('./client.js').PaginationParameters} [params] - Optional pagination params
     * @returns {Promise<unknown>}
     *
     * @example
