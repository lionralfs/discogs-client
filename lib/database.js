...
module.exports = function (client) {
    ...
    database.artist = deprecate.function(database.getArtist, 'database.artist: Use database.getArtist instead');
    ...
    database.artistReleases = deprecate.function(
        database.getArtistReleases,
    ...
    database.release = deprecate.function(database.getRelease, 'database.release: Use database.getRelease instead');
    ...
    database.master = deprecate.function(database.getMaster, 'database.master: Use database.getMaster instead');
    ...
    database.masterVersions = deprecate.function(
        database.getMasterVersions,
    ...
    database.label = deprecate.function(database.getLabel, 'database.label: Use database.getLabel instead');
    ...
    database.labelReleases = deprecate.function(
        database.getLabelReleases,
    ...
    database.image = deprecate.function(database.getImage, 'database.image: Use database.getImage instead');
    ...
    database.search = function (query, params, callback) {
        ...
        if (arguments.length <= 2) {
            if (typeof params === 'function') {
                callback = params;
            } // No extra search params, the callback is the second function param
        } else {
            obj = params;
        }
        if (query) {
