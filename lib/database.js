 ...
 * @typedef {{currency: Currency; value: number}} Price
 * @typedef {import('./client.js').PaginationParameters} PaginationParameters
 * @typedef {{anv: string; id: number; join: string; name: string; resource_url: string; role: string; tracks: string}} Artist
 * @typedef {{height: number; resource_url: string; type: string; uri: string; uri150: string; width: number}} Image
 * @typedef {{duration: string; position: string; title: string; type_: string; extraartists?: Array<Artist>}} Tracklisting
 */
...
export default function (client) {
     ...
     * @typedef {{namevariations: Array<string>; profile: string; releases_url; string; resource_url: string; uri: string; urls: Array<string>; data_quality: string; id: number; images: Array<Image>; members: Array<{active: boolean; id: number; name: string; resource_url: string;}>}} GetArtistResponse
     ...
     * @param {(number|string)} release - The Discogs release ID
     * @typedef {{num_have: number; num_want: number}} GetReleaseStatsResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<GetReleaseStatsResponse>>}
     *
     ...
     * @typedef {{styles: Array<string>; genres: Array<string>; videos: Array<{duration: number; description: string; embed: boolean; uri: string; title: string}>; title: string; main_release: number; main_release_url: string; uri: string; artists: Array<Artist>; versions_url: string; year: number; images: Array<Image>; resource_url: string; tracklist: Array<Tracklisting>; id: number; num_for_sale: number; lowest_price: number; data_quality: string;}} GetMasterResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<GetMasterResponse>>}
     *
     ...
     * @typedef {{versions: Array<{status: string; stats: {user: {in_collection: number; in_wantlist: number;}; community: {in_collection: number; in_wantlist: number}}; thumb: string; format: string; country: string; title: string; label: string; released: string; major_formats: Array<string>; catno: string; resource_url: string; id: number}>}} GetMasterVersionsResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<GetMasterVersionsResponse & import('./client.js').PaginationResponse>>}
     *
     ...
     * @typedef {{profile: string; releases_url: string; name: string; contact_info: string; uri: string; sublabels: Array<{resource_url: string; id: number; name: string;}>; urls: Array<string>; images: Array<Image>; resource_url: string; id: number; data_quality: string}} GetLabelResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<GetLabelResponse>>}
     *
     ...
     * @typedef {{releases: Array<{artist: string; catno: string; format: string; id: number; resource_url: string; status: string; thumb: string; title: string; year: number}>}} GetLabelReleasesResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<GetLabelReleasesResponse & import('./client.js').PaginationResponse>>}
     *
     ...
     *
     * @typedef {{results: Array<{style: Array<string>; thumb: string; title: string; country: string; format: Array<string>; uri: string; community: {want: number; have: number}; label: Array<string>; catno: string; year: string; genre: Array<string>; resource_url: string; type: string; id: number}>}} SearchResponse
     * @returns {Promise<import('./client.js').RateLimitedResponse<SearchResponse & import('./client.js').PaginationResponse>>}
     *
