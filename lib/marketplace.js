...
module.exports = function (client) {
    ...
    marketplace.inventory = deprecate.function(
        marketplace.getInventory,
    ...
    marketplace.listing = deprecate.function(
    ...
    marketplace.orderMessages = deprecate.function(
        marketplace.getOrderMessages,
    ...
    marketplace.orderAddMessage = deprecate.function(
        marketplace.addOrderMessage,
    ...
    marketplace.fee = deprecate.function(marketplace.getFee, 'marketplace.fee: Use marketplace.getFee instead');
    ...
    marketplace.suggestPrice = deprecate.function(
