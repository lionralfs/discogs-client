...
export class DiscogsClient {
     ...
     * @param {{url: string, method: 'GET'|'POST'|'PUT'|'DELETE', data: Record<string, any>, queue: boolean, json: boolean; authLevel: number }} options - Request options
