...
const { version, homepage } = JSON.parse(readFileSync(new URL('../package.json', import.meta.url)));

/**
 * @typedef {(err: DiscogsError | null, data: unknown, rateLimit?: {limit: number, used: number, number}) => any} CallbackFn
 */
